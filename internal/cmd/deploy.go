...
func newDeployCommand() *deployCommand {
	...
	deployCommand.cmd.Flags().StringVar(&deployCommand.args.TargetOptions.HealthCheckConfig.Protocol, "health-check-protocol", server.DefaultHealthCheckProtocol, "Protocol to health check with (http or websocket)")
	deployCommand.cmd.Flags().StringVar(&deployCommand.args.TargetOptions.HealthCheckConfig.WebSocketSubprotocol, "health-check-websocket-subprotocol", "", "Subprotocol to request when health checking with websocket")
